...
<h2><?= __d('DebugKit', 'Application Constants') ?></h2>
...
<?php else: ?>
<div class="warning">
    <?= __d('DebugKit', 'No application environment available.'); ?>
</div>
<?php endif; ?>

<h2><?= __d('DebugKit', 'CakePHP Constants') ?></h2>
...
<?php else: ?>
<div class="warning">
    <?= __d('DebugKit', 'CakePHP environment unavailable.'); ?>
</div>
<?php endif; ?>

<h2><?= __d('DebugKit', 'PHP Environment') ?></h2>
...
<?php else: ?>
<div class="warning">
    <?= __d('DebugKit', 'PHP environment unavailable.'); ?>
</div>
<?php endif; ?>

<?php if (isset($hidef)): ?>
    <h2><?= __d('DebugKit', 'Hidef Environment') ?></h2>
    ...
    <?php else: ?>
    <div class="warning">
        <?= __d('DebugKit', 'No Hidef environment available.'); ?>
    </div>
    <?php endif; ?>
<?php endif; ?>
