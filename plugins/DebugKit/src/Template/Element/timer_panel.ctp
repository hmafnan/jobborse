...
?>
<section>
    <h3><?= __d('DebugKit', 'Memory') ?></h3>
    <div class="peak-mem-use">
        <strong><?= __d('DebugKit', 'Peak Memory Use:') ?></strong>
    ...
    <table cellspacing="0" cellpadding="0">
        <thead>
            <tr>
                <th><?= __d('DebugKit', 'Message') ?></th>
                <th><?= __d('DebugKit', 'Memory Use') ?></th>
            </tr>
        </thead>
        <tbody>
...
<section>
    <h3><?= __d('DebugKit', 'Timers') ?></h3>
    <div class="request-time">
        <strong><?= __d('DebugKit', 'Total Request Time:') ?></strong>
    ...
    <table cellspacing="0" cellpadding="0">
        <thead>
        <tr>
            <th><?= __d('DebugKit', 'Event') ?></th>
            <th><?= __d('DebugKit', 'Time in ms') ?></th>
            <th><?= __d('DebugKit', 'Timeline') ?></th>
        </tr>
        </thead>
        <tbody>
        <?php
